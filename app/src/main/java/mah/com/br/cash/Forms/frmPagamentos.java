...
import mah.com.br.cash.Adapters.adpPagamentos;
...
public class frmPagamentos extends AppCompatActivity {

    public static adpPagamentos mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView mRecyclerView = (RecyclerView) findViewById(R.id.rvPagamentos);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(frmPagamentos.this));
        mRecyclerView.addItemDecoration(new SpacesItemDecoration(Funcoes.SPACE_BETWEEN_ITEMS));

        mAdapter = new adpPagamentos(
                frmPagamentos.this,
                mRecyclerView,
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(frmPagamentos.this, frmManutencaoPagamentos.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.mnu_pagamentos, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.mnuAlterar) {
            ...
            if (mAdapter.mItemSelected == -1) {
                Funcoes.showMessage(frmPagamentos.this, getString(R.string.a_004), getString(R.string.e_015), getString(R.string.o_002));
            } else {
                Intent intent = new Intent(frmPagamentos.this, frmManutencaoPagamentos.class);
        ...
        if (id == R.id.mnuExcluir) {
            ...
            if (mAdapter.mItemSelected == -1) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(frmPagamentos.this);

                builder.setTitle(getString(R.string.c_008));

                String sMessage = getString(R.string.d_021);
                sMessage = sMessage.replace("@1", mAdapter.mListPagamentos.get(mAdapter.mItemSelected).getDtPagamento());
    ...
    private void montaComboOrdem() {
        ...
        String[] vOrdem = {
                ...
                getString(R.string.d_020),
                getString(R.string.v_018)
        };
    ...
    private void montaComboListagem() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
            if (ContextCompat.checkSelfPermission(frmPagamentos.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
