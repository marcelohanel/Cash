...
public class adpCompraItens extends RecyclerView.Adapter<adpCompraItens.MyViewHolder> implements Filterable {

    public List<tblCompraItens> mListItens;
    public int mItemSelected;
    public int mOrdem;

    private int mIdCompra;
    private List<tblCompraItens> mListItensFull;
    ...
    public adpCompraItens(Context c, RecyclerView r, int id_compra) {
    ...
    private List<tblCompraItens> getDados() {

        List<tblCompraItens> mList;
    ...
    public void order() {
        ...
        comCompraItens mComparator = new comCompraItens(mOrdem);
    ...
    public void insert(tblCompraItens item) {
    ...
    public void update(tblCompraItens item) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = mLayoutInflater.inflate(R.layout.list_compra_itens, viewGroup, false);
    ...
    private class DomainFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint == null || constraint.length() == 0) {
                List<tblCompraItens> list = new ArrayList<>(mListItensFull);
                results.count = list.size();
                results.values = list;
            } else {
                ArrayList<tblCompraItens> newValues = new ArrayList<>(mListItensFull.size());
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            ...
            if (results.values != null) {
                mListItens = (ArrayList<tblCompraItens>) results.values;
            } else {
