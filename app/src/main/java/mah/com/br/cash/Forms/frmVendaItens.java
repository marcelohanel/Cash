...
import mah.com.br.cash.Adapters.adpVendaItens;
import mah.com.br.cash.Diversos.Funcoes;
import mah.com.br.cash.Diversos.SpacesItemDecoration;
import mah.com.br.cash.R;

public class frmVendaItens extends AppCompatActivity {

    public static adpVendaItens mAdapter;
    private int iVenda;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.mnu_venda_itens, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.mnuExcluir) {
            ...
            if (mAdapter.mItemSelected == -1) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(frmVendaItens.this);
