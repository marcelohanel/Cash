...
import mah.com.br.cash.Adapters.adpClientes;
import mah.com.br.cash.Diversos.Funcoes;
import mah.com.br.cash.Diversos.SpacesItemDecoration;
import mah.com.br.cash.R;

public class frmClientes extends AppCompatActivity {

    public static adpClientes mAdapter;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.mnu_clientes, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.mnuAlterar) {
            ...
            if (mAdapter.mItemSelected == -1) {
                Funcoes.showMessage(frmClientes.this, getString(R.string.a_004), getString(R.string.e_001), getString(R.string.o_002));
            } else {
                Intent intent = new Intent(frmClientes.this, frmManutencaoClientes.class);
        ...
        if (id == R.id.mnuExcluir) {
            ...
            if (mAdapter.mItemSelected == -1) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(frmClientes.this);

                builder.setTitle(getString(R.string.c_008));

                String sMessage = getString(R.string.d_002);
                sMessage = sMessage.replace("@1", mAdapter.mListClientes.get(mAdapter.mItemSelected).getNome());
    ...
    private void montaComboListagem() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
            if (ContextCompat.checkSelfPermission(frmClientes.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
