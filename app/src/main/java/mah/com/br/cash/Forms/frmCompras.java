...
import mah.com.br.cash.Adapters.adpCompras;
...
public class frmCompras extends AppCompatActivity {

    public static adpCompras mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.frm_compras);
        ...
        RecyclerView mRecyclerView = (RecyclerView) findViewById(R.id.rvCompras);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(frmCompras.this));
        mRecyclerView.addItemDecoration(new SpacesItemDecoration(Funcoes.SPACE_BETWEEN_ITEMS));

        mAdapter = new adpCompras(
                frmCompras.this,
                mRecyclerView,
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(frmCompras.this, frmManutencaoCompras.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.mnu_compras, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.mnuDetalhamento) {
            if (mAdapter.mItemSelected == -1) {
                Funcoes.showMessage(frmCompras.this, getString(R.string.a_004), getString(R.string.e_010), getString(R.string.o_002));
            } else {
        ...
        if (id == R.id.mnuItens) {
            if (mAdapter.mItemSelected == -1) {
                Funcoes.showMessage(frmCompras.this,
                        getString(R.string.a_004),
                        getString(R.string.e_010),
                        getString(R.string.o_002));
            } else {
                Intent intent = new Intent(frmCompras.this, frmCompraItens.class);
                intent.putExtra("Compra", mAdapter.mListCompras.get(mAdapter.mItemSelected).getIdCompra());
                startActivity(intent);
            }
        }

        if (id == R.id.mnuPagamentos) {
            if (mAdapter.mItemSelected == -1) {
                Funcoes.showMessage(frmCompras.this,
                        getString(R.string.a_004),
                        getString(R.string.e_010),
                ...
                Intent intent = new Intent(frmCompras.this, frmCompraPagamentos.class);
                intent.putExtra("Compra", mAdapter.mListCompras.get(mAdapter.mItemSelected).getIdCompra());
                startActivity(intent);
            }
        }
        ...
        if (id == R.id.mnuExcluir) {
            ...
            if (mAdapter.mItemSelected == -1) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(frmCompras.this);

                builder.setTitle(getString(R.string.c_008));

                String sMessage = getString(R.string.d_007);
                sMessage = sMessage.replace("@1", mAdapter.mListCompras.get(mAdapter.mItemSelected).getIdentificacao());
    ...
    private void montaComboOrdem() {
        ...
        String[] vOrdem = {
                ...
                getString(R.string.d_006),
                getString(R.string.v_001)
        };
    ...
    private void montaComboListagem() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
            if (ContextCompat.checkSelfPermission(frmCompras.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
