...
public class frmCompraItens extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(frmCompraItens.this, frmManutencaoCompraItens.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.mnu_compra_itens, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.mnuExcluir) {
            ...
            if (mAdapter.mItemSelected == -1) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(frmCompraItens.this);

                builder.setTitle(getString(R.string.c_008));

                String sMessage = getString(R.string.d_008);
                sMessage = sMessage.replace("@1", mAdapter.mListItens.get(mAdapter.mItemSelected).getCalcNomeProduto());
