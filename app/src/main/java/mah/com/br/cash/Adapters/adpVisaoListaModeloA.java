...
public class adpVisaoListaModeloA extends RecyclerView.Adapter<adpVisaoListaModeloA.MyViewHolder> {
    ...
    public adpVisaoListaModeloA(Context c, List<TempValores> v) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = mLayoutInflater.inflate(R.layout.list_lista_modelo_a, viewGroup, false);
